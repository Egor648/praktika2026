...
public class Lot extends TableImpl<LotRecord> {
     ...
     */
    public final TableField<LotRecord, BigDecimal> PRICE = createField(DSL.name("price"), SQLDataType.NUMERIC(15, 2), this, "");
     ...
     */
    public final TableField<LotRecord, String> NDS_RATE = createField(DSL.name("nds_rate"), SQLDataType.VARCHAR(20), this, "");
    ...
    public List<Check<LotRecord>> getChecks() {
        return Arrays.asList(
            ...
            Internal.createCheck(this, DSL.name("lot_nds_rate_check"), "(((nds_rate)::text = ANY ((ARRAY['ЃҐ§ Ќ„‘'::character varying, '18%'::character varying, '20%'::character varying])::text[])))", true)
        );
    }
